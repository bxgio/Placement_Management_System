...
<head>
  ...
  <title>Company Applied List</title>
      ...
      <div class="py-4 text-gray-500 dark:text-gray-400">
        ...
        <ul>
          ...
          <li class="relative px-6 py-3">
            ...
            <a class="inline-flex items-center w-full text-sm font-semibold text-gray-800 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200 dark:text-gray-100" href="applied.php">
                ...
                <div class="table-responsive">
                  <table class="table table-striped">
                    ...
                    <tr
                      ...
                      <th class="px-4 py-3" style="text-align: center;">Job Title</th>
                      <th class="px-4 py-3" style="text-align: center;">location</th>
                      <th class="px-4 py-3" style="text-align: center;">Contact</th>
                      <th class="px-4 py-3" style="text-align: center;">vacancy</th>
                      <th class="px-4 py-3" style="text-align: center;">Interview Date</th>
                      </tr>
                    </thead>
                    <tbody class="table-group-divider">
                      <?php
                      $course = mysqli_query($con, "SELECT * FROM pdf where s_id=$_SESSION[id]");
                      $i = 1;
                      while ($row = mysqli_fetch_array($course)) {
                        $apply = mysqli_query($con, "SELECT * FROM newplacement where id=$row[c_id]");
                        $apply_row = mysqli_fetch_assoc($apply);
                      ?>
                        <tr style="margin-bottom: 30px;">
                          <td style="text-align: center;"><?php echo $i; ?></td>
                          <td style="text-align: center;"><?php echo $apply_row['name']; ?></td>
                          <td style="text-align: center;"><?php echo $apply_row['title']; ?></td>
                          <td style="text-align: center;"><?php echo $apply_row['location']; ?></td>
                          <td style="text-align: center;"><?php echo $apply_row['contact']; ?></td>
                          <td style="text-align: center;"><?php echo $apply_row['vacancy']; ?></td>
