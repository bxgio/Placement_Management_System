...
if (isset($_POST['update'])) {
  ...
  if (mysqli_query($con, $s)) {
    ...
    echo "<script>alert('Updated');window.location='companydetails.php';</script>";
  } else {
        ...
        <div class="container px-6 mx-auto" style="width:90%"> <!-- Increased width to 80% -->
          ...
          <form action="" method="post">
            <table class="w-full">
              ...
              <tr class="py-2 px-4 mb-4">
                <td><label for="" class="text-gray-700 dark:text-gray-200">Interview Date:</label></td>
