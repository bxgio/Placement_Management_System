      ...
      <div class="py-4 text-gray-500 dark:text-gray-400 bg-green-50">
        ...
        <ul>
          <li class="relative px-6 py-3">
            <a class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200" href="studentprofile.php">
              <svg class="w-5 h-5" aria-hidden="true" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div class="table-responsive">
                  <table class="table table-striped">
                    ...
                    <tr
                      ...
                      <th class="px-4 py-3" style="text-align: center;">Company Name</th>
                      <th class="px-4 py-3" style="text-align: center;">Job Role</th>
                      <th class="px-4 py-3" style="text-align: center;">Qualification</th>
                      <th class="px-4 py-3" style="text-align: center;">location</th>
                      <th class="px-4 py-3" style="text-align: center;">Contact</th>
                      <th class="px-4 py-3" style="text-align: center;">Interview Date</th>
                      <!-- <th class="px-4 py-3" style="text-align: center;">Description</th> -->
                      </tr>
                    </thead>
