...
$select = mysqli_query($con, "SELECT * FROM studentdetail");
...
$id1 = $_SESSION['id'];
$select1 = "SELECT * FROM admin WHERE id='$id1'";
...
<body>
    <div class="flex h-screen bg-gray-50 dark:bg-gray-900" :class="{ 'overflow-hidden': isSideMenuOpen}">
        ...
        <aside class="z-20 hidden w-64 overflow-y-auto bg-white dark:bg-gray-800 md:block flex-shrink-0">
            <div class="py-4 text-gray-500 dark:text-gray-400 bg-green-50">
                ...
                <ul class="mt-6">
                    <li class="relative px-10 py-3">
                        <a class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200" href="home.php">
                ...
                <ul>
                    <li class="relative px-6 py-3">
                        ...
                        <a class="inline-flex items-center w-full text-sm font-semibold text-gray-800 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200 dark:text-gray-100" href="studentprofile.php">
                            <svg class="w-5 h-5" aria-hidden="true" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor">
                                <path d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01">
                                </path>
                            </svg>
                            <span class="ml-4">Student Details</span>
                        </a>
                    </li>
                    <li class="relative px-6 py-3">
                        <a class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200" href="newplacement.php">
                            ...
                            <span class="ml-4">Add Company</span>
                        </a>
                    </li>
                    <li class="relative px-6 py-3">
                        <a class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200" href="companydetails.php">
        ...
        <aside class="fixed inset-y-0 z-20 flex-shrink-0 w-64 mt-16 overflow-y-auto bg-white dark:bg-gray-800 md:hidden" x-show="isSideMenuOpen" x-transition:enter="transition ease-in-out duration-150" x-transition:enter-start="opacity-0 transform -translate-x-20" x-transition:enter-end="opacity-100" x-transition:leave="transition ease-in-out duration-150" x-transition:leave-start="opacity-100" x-transition:leave-end="opacity-0 transform -translate-x-20" @click.away="closeSideMenu" @keydown.escape="closeSideMenu">
            <div class="py-4 text-gray-500 dark:text-gray-400 bg-green-50">
                ...
                <ul>
                    ...
                    <!-- <li class="relative px-6 py-3">
                        <a class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200" href="profile.php">
        ...
        <div class="flex flex-col flex-1 w-full">
            ...
            <?php
            $stud_id = $_GET['id'];
            $stud = mysqli_query($con, "SELECT * FROM `studentdetail` WHERE id = $stud_id");
            $s = mysqli_fetch_array($stud);
            ?>
                ...
                <div class="container custom-container px-9 mx-auto my-4">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="card">
                                <div class="card-body">
                                    <h2 class="card-title text-primary mb-4 text-center">Student Information</h2>
                                        ...
                                        <table class="table table-bordered table-lg mx-auto">
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="2" class="text-center align-middle"> <!-- Added 'align-middle' for vertical centering -->
                                                        <?php
                                                ...
                                                <!-- Department Number Row -->
                                                <tr>
                                                    <th>Department Number</th>
                                                    <td><?php echo $s['dno']; ?></td>
                                                </tr>
                                                <!-- Major Row -->
                                                <tr>
                                                    <th>Major</th>
                        ...
                        <div class="col-md-6">
                            <div class="card">
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <h2 class="card-title text-primary mb-4 text-center">Academic Information</h2>
                                        <table class="table table-bordered table-lg mx-auto">
                                            <tbody>
                                                <tr>
                                                    <td><strong>10th Percentage</strong></td>
                                                    <td><?php echo $s['10th']; ?></td>
                                                </tr>
                                                <tr>
                                                    <td><strong>12th Percentage</strong></td>
                                                    <td><?php echo $s['12th']; ?></td>
                                                </tr>
                                                <tr>
                                                    <td><strong>Current Semester Percentage</strong></td>
                                                    <td><?php echo $s['1st']; ?></td>
                                                </tr>
