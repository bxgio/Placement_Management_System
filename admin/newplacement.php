      ...
      <div class="py-4 text-gray-500 dark:text-gray-400 bg-green-50">
        ...
        <ul>
          ...
          <li class="relative px-6 py-3">
            ...
            <a class="inline-flex items-center w-full text-sm font-semibold text-gray-800 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200 dark:text-gray-100" href="newplacement.php">
              ...
              <form action="" method="post">
                <table class="table-auto w-full">
                  ...
                  <tr>
                    ...
                    <td>
                      <input type="number" class="form-control" name="contact" id="contact" placeholder="Enter your contact" required>
                    </td>
                  </tr>
                  <tr>
